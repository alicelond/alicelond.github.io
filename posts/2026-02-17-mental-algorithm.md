...
excerpt: Even though the use of AI coding tools increases in industry, the knowledge of fundamentals of computing skills is still relevant for code reviewing, algorithm analysis and debugging, specially worst case analysis or simply Big-O notation.
---
...
It's common to use built-in function dependendin on a given programming language when you're writing an algorithm. Be mindful of them when analysing time complexity.
