...
excerpt: Did you know we can use formal mathematical proofs to verify a complex DSP design, from its ideal equation all the way down to the hardware gate level? It's a powerful way to tackle the subtle but critical bugs that plague our work.
---
